...
```
language / env        years    notes
──────────────────────────────────────────────────
C#                    9 yrs    primary language
LuaU / Roblox Studio  7 yrs    scripting & game systems
Python                6+ mo    automation, tooling
JavaScript            6+ mo    web + scripting
HTML / CSS            6+ mo    frontend when needed
```
...
```
os        Windows 11
editor    Visual Studio · VS Code · Roblox Studio + Rojo
```
...
- **automate** things that shouldn't need a human
- **reverse** systems to understand how they actually work
- **build tools** that solve my own problems first
- **explore** new attack surfaces, optimizations, and rabbit holes
